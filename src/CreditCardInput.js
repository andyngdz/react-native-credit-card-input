...
/* eslint react/prop-types: 0 */ export default class CreditCardInput extends Component {
  ...
  _focus = field => {
    if (!field) return;
    if(!this.scrollViewHorizontal) return;
  ...
  render() {
    ...
    /**
     * Default ScrollView will be horizontal
     */
    this.scrollViewHorizontal = true;
    /**
     * Check if user passed horizontal prop
     */
    if (typeof horizontal !== undefined) {
      this.scrollViewHorizontal = horizontal;
    }
    ...
    return (
      <View style={s.container}>
        ...
        <ScrollView
          ref="Form"
          horizontal={this.scrollViewHorizontal}
